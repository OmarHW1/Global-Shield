...
export default function RequestPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("Request submitted:", { requestType, ...formData })
      ...
      <div className="min-h-screen bg-white pt-16">
        <section className="py-24 bg-black text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Booking Confirmed</h1>
            ...
            <div className="bg-gray-900 rounded-lg p-1 flex">
              <button
                ...
                className={`px-6 py-3 rounded-md font-medium transition-all ${
                  requestType === "consultation" ? "bg-white text-black" : "text-gray-300 hover:text-white"
                }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 rounded-md font-medium transition-all ${
                  requestType === "immediate" ? "bg-red-600 text-white" : "text-gray-300 hover:text-white"
                }`}
              >
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex items-center justify-center space-x-4">
              ...
              <span className="font-medium">
                For immediate threats or emergencies, call our 24/7 hotline: +44 (0) 749 758 0732
              </span>
            </div>
          </div>
        </section>
              ...
              <Card className="shadow-lg border-0">
                ...
                <CardContent className="space-y-4">
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    ...
                    <p className="text-red-700 font-bold text-lg">+44 (0) 749 758 0732</p>
